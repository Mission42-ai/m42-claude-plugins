...
### Fixed
- Fixed hardcoded script paths in extract and review commands to use `${CLAUDE_PLUGIN_ROOT}` for portability
...
### Changed
- Updated extract command documentation to remove deprecated terminology
