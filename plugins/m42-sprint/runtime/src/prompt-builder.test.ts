...
// ============================================================================
// Type Definitions (local copies for testing)
// ============================================================================
 ...
 */
function createSimplePhaseProgress(): CompiledProgress {
  return {
 ...
 */
function createForEachProgress(): CompiledProgress {
  return {
        ...
        steps: [
          {
            ...
            status: 'completed',
            phases: [
              { id: 'red', prompt: 'Write failing tests', status: 'completed' } as CompiledPhase,
              { id: 'green', prompt: 'Implement to pass tests', status: 'completed' } as CompiledPhase,
              { id: 'refactor', prompt: 'Refactor code', status: 'completed' } as CompiledPhase,
            ],
          } as CompiledStep,
          {
            id: 'feature-b',
            ...
            status: 'in-progress',
            phases: [
              { id: 'red', prompt: 'Write failing tests for validation', status: 'in-progress' } as CompiledPhase,
              { id: 'green', prompt: 'Implement validation logic', status: 'pending' } as CompiledPhase,
              { id: 'refactor', prompt: 'Clean up validation code', status: 'pending' } as CompiledPhase,
            ],
          } as CompiledStep,
          {
            id: 'feature-c',
            ...
            status: 'pending',
            phases: [
              { id: 'red', prompt: 'Write failing API tests', status: 'pending' } as CompiledPhase,
              { id: 'green', prompt: 'Implement API handlers', status: 'pending' } as CompiledPhase,
              { id: 'refactor', prompt: 'Optimize API code', status: 'pending' } as CompiledPhase,
            ],
          } as CompiledStep,
        ],
      } as CompiledTopPhase,
 ...
 */
function createRetryProgress(): CompiledProgress {
...
test('buildPrompt: loads context files from sprint directory', () => {
  ...
  try {
    ...
    fs.writeFileSync(
      path.join(ctx.contextDir, '_shared.md'),
...
test('buildPrompt: phase index at end of phases', () => {
  ...
  try {
    const progress: CompiledProgress = {
      ...
      phases: [
        { id: 'p0', status: 'completed', prompt: 'Phase 0' } as CompiledTopPhase,
        { id: 'p1', status: 'completed', prompt: 'Phase 1' } as CompiledTopPhase,
        { id: 'p2', status: 'in-progress', prompt: 'Phase 2 - Last one' } as CompiledTopPhase,
      ],
    };
