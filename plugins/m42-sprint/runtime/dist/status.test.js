...
import { listAllWorktrees, findSprintsInWorktree, readSprintProgress, discoverSprints, formatSprintStatus, formatCrossWorktreeStatus, formatCurrentWorktreeStatus, getStatusColor, } from './status.js';
// ============================================================================
// Test Utilities
// ============================================================================
...
function createSprintDir(worktreePath, sprintId, progress) {
        ...
        sprints: [
            {
                ...
                progress: { 'sprint-id': 'sprint1', status: 'in-progress' },
                isCurrent: true,
            },
            {
                sprintDir: '/wt/.claude/sprints/sprint2/',
                worktree: { path: '/wt', branch: 'feature', isMain: false, head: 'def' },
                progress: { 'sprint-id': 'sprint2', status: 'completed' },
                isCurrent: false,
            },
        ],
        currentWorktree: { isWorktree: false, path: '/test', id: 'abc', mainWorktreePath: '/test' },
    ...
    const result = {
        sprints: [
            ...
            },
            {
                sprintDir: '/wt/.claude/sprints/sprint2/',
                worktree: { path: '/wt', branch: 'feature', isMain: false, head: 'def' },
                progress: { 'sprint-id': 'sprint2', status: 'in-progress' },
                isCurrent: false,
            },
        ],
        currentWorktree: { isWorktree: false, path: '/test', id: 'abc', mainWorktreePath: '/test' },
