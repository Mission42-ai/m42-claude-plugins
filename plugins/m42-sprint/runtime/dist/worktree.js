 ...
 */
export function substituteWorktreeVars(template, vars) {
    return template
 ...
 */
export function extractSprintName(sprintId) {
 ...
 * Assumes format: YYYY-MM-DD_<sprint-name>
 */
export function extractDate(sprintId) {
 ...
 */
export function checkBranchExists(branchName, cwd) {
 ...
 */
export function createBranch(branchName, cwd, baseBranch) {
 ...
 */
export function createGitWorktree(worktreePath, branchName, cwd) {
 ...
 */
export function createWorktree(config, sprintId, workflow, repoRoot, options = {}) {
 ...
 */
export function buildWorktreeProgressSection(result, config) {
    return {
        enabled: true,
 ...
 */
export function formatWorktreeSuccessMessage(result, baseBranch) {
 ...
 */
export function formatWorktreeErrorMessage(result) {
 ...
 */
export function buildWorktreeMetadata(cwd) {
    const info = getWorktreeInfo(cwd);
    return {
        'worktree-id': info.id,
 ...
 */
export function getProjectRoot(sprintDir) {
