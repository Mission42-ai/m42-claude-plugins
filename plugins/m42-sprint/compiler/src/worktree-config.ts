 ...
 */
const DEFAULT_CLEANUP = 'on-complete' as const;

/**
 * Variables available for substitution in worktree templates
 */
interface WorktreeVariables {
  'sprint-id': string;
  'sprint-name': string;
  date: string;
}
 ...
 */
function extractSprintName(sprintId: string): string {
 ...
 */
function extractDate(sprintId: string): string {
 ...
 */
function substituteVars(template: string, vars: WorktreeVariables): string {
  return template
 ...
 */
export function extractWorktreeConfig(
  workflow: WorkflowDefinition
): WorkflowWorktreeDefaults | undefined {
...
export function resolveWorktreePath(
  sprintId: string,
  workflowDefaults: WorkflowWorktreeDefaults | undefined,
  sprintWorktree: WorktreeConfig | undefined
 ...
 */
export function mergeWorktreeConfigs(
  sprintId: string,
  sprint: SprintDefinition,
  workflow: WorkflowDefinition
): CompiledWorktreeConfig | undefined {
