...
test('buildDependencyGraphForPhase should handle wide parallel DAG', async () => {
    ...
    assert(blockedLabel.includes('step-A') && blockedLabel.includes('step-B'), 'step-D blockedByLabel should mention multiple deps');
    // Check maxColumn
...
//# sourceMappingURL=dependency-graph-transforms.test.js.map