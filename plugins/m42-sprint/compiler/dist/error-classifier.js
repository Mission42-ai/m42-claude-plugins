...
exports.formatInterventionEntry = formatInterventionEntry;
/**
 ...
 */
const retryableCategories = ['network', 'rate-limit', 'timeout'];
/**
 ...
 */
function classifyError(exitCode, errorMessage) {
 ...
 */
function shouldRetry(category, retryOn) {
 ...
 */
function getRecoveryAction(category) {
    switch (category) {
        case 'network':
        case 'rate-limit':
        case 'timeout':
 ...
 */
function formatInterventionEntry(phaseId, error, category) {
    const entry = {
        phaseId,
