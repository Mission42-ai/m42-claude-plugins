 ...
 */
function expandStep(step, stepIndex, workflow, context, modelContext = {}) {
 ...
 */
function expandForEach(phase, steps, workflowsDir, defaultWorkflow, context, errors, modelContext = {}) {
    const compiledSteps = [];
