...
test('pdf module exports createPdfDocument function', () => {
    assert(typeof pdf_generator_js_1.createPdfDocument === 'function', 'createPdfDocument should be a function');
});
...
test('createPdfDocument handles sprint with different statuses', async () => {
    ...
    const results = await Promise.all([
        (0, pdf_generator_js_1.createPdfDocument)(progressInProgress, createTestPdfOptions()),
        (0, pdf_generator_js_1.createPdfDocument)(progressBlocked, createTestPdfOptions()),
        (0, pdf_generator_js_1.createPdfDocument)(progressPaused, createTestPdfOptions()),
    ]);
...
test('createPdfDocument handles missing optional fields', async () => {
    ...
    const result = await (0, pdf_generator_js_1.createPdfDocument)(minimalProgress, options);
...
test('createPdfDocument handles undefined options gracefully', async () => {
    ...
    const result = await (0, pdf_generator_js_1.createPdfDocument)(progress, {});
