...
exports.createProgressChart = createProgressChart;
exports.createPieChart = createPieChart;
exports.createProgressBar = createProgressBar;
exports.createTimelineChart = createTimelineChart;
// ============================================================================
// Color Palette
// ============================================================================
const STATUS_COLORS = {
 ...
 */
function formatChartLabel(value, total) {
    if (total === 0)
        return '0%';
 ...
 * @returns SVG string
 */
function createProgressChart(data, options = {}) {
 ...
 * @returns SVG string
 */
function createPieChart(segments, options = {}) {
 ...
 */
function renderLegend(segments, width, chartHeight, showLabels) {
 ...
 * @returns SVG string
 */
function createProgressBar(data, options = {}) {
 ...
 */
function renderBarLegend(segments, width, barHeight) {
 ...
 * @returns SVG string
 */
function createTimelineChart(entries, options = {}) {
